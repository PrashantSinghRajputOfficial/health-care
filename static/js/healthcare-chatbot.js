...
const KNOWLEDGE_BASE = {
    ...
    login: {
        keywords: ['login', 'sign in', 'password', 'forgot password', 'account', 'authentication', 'Patient ID', 'credentials', 'reset', 'demo'],
        responses: [
            {
...
function getContextualSuggestions(category) {
    const suggestions = {
        login: ['Reset password', 'Email help', 'Demo credentials', 'Login errors'],
